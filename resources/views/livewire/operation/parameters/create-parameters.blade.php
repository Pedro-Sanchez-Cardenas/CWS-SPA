<div class="card" x-data="parameters()" x-cloak>
    ...
    <form class="border-top" wire:submit.prevent="store">
        ...
        @for ($pre = 1; $pre <= $plant->trains->where('type', 'Train')->count() * 2; $pre++)
            ...
            <div class="card-body" x-show.transition.in="step === {{ $pre }}">
                @if ($plant->personalitation_plant->well_pump == 'yes' || $plant->personalitation_plant->feed_pump ==
                'yes')
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" pump.well.$pre") border border-danger @enderror"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)"  class="form-control @error(" pump.well.$pre") border border-danger
                                @enderror" wire:model="pump.well.{{ $pre }}" placeholder="0.0 A">
                        </div>
                        @error("pump.well.$pre")
                    ...
                    <div class="col-sm-6 mb-2">
                        <label class="form-label">Feed
                            pump</label>
                        <div class="input-group">
                            <span class="input-group-text @error(" pump.feed.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" pump.feed.$pre") border border-danger
                                @enderror" wire:model="pump.feed.{{ $pre }}" placeholder="0.0 A">
                        </div>
                        @error("pump.feed.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        <label class="form-label">Well
                            pump</label>
                        <div class="input-group">
                            <span class="input-group-text @error(" pump.wellf.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" pump.wellf.$pre") border border-danger
                                @enderror" wire:model="pump.wellf.{{ $pre }}" placeholder="0.0 Hz">
                        </div>
                    ...
                    <div class="col-6 mb-2">
                        <label class="form-label">Feed
                            pump</label>
                        <div class="input-group">
                            <span class="input-group-text @error(" pump.feedf.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" pump.feedf.$pre") border border-danger
                                @enderror" wire:model="pump.feedf.{{ $pre }}" placeholder="0.0 Hz">
                        </div>
                ...
                @for ($i = 1; $i <= $plant->multimedia_filters_quantity; $i++)
                    <div class="row">
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                <span class="input-group-text @error(" mm.in.$pre.$i") border border-danger @enderror"
                                    id="basic-addon-search1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" mm.in.$pre.$i") border border-danger
                                    @enderror" wire:model="mm.in.{{ $pre }}.{{ $i }}" placeholder="0.0 psi">
                            </div>
                            @error("mm.in.$pre.$i")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                <span class="input-group-text @error(" mm.out.$pre.$i") border border-danger @enderror"
                                    id="basic-addon-search1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" mm.out.$pre.$i") border border-danger
                                    @enderror" wire:model="mm.out.{{ $pre }}.{{ $i }}" placeholder="0.0 psi">
                            </div>
                            @error("mm.out.$pre.$i")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="mb-1">
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" backwash.$pre") border border-danger
                                @enderror" wire:model="backwash.{{ $pre }}" placeholder="0.0 min">
                        </div>
                        @error("backwash.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="row">
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" pf.in.$pre") border border-danger
                                    @enderror" wire:model="pf.in.{{ $pre }}" placeholder="0.0 psi">
                            </div>
                            @error("pf.in.$pre")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" pf.out.$pre") border border-danger
                                    @enderror" wire:model="pf.out.{{ $pre }}" placeholder="0.0 psi">
                            </div>
                            @error("pf.out.$pre")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="mt-3">
                        <div class="form-floating mb-0">
                            <textarea data-length="350" class="form-control char-textarea"
                                wire:model="observations.pre.{{ $pre }}" rows="5" placeholder="Observations"
            ...
            <div class="card-body" x-show.transition.in="step === {{ $pre }}">
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" hp.amp.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" hp.amp.$pre") border border-danger
                                @enderror" wire:model="hp.amp.{{ $pre }}" placeholder="0.0 A">
                        </div>
                        @error("hp.amp.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    @for ($i = 1; $i <= $plant->trains->first()->boosters_quantity; $i++)
                        <div class="col-6 mb-2">
                            <label class="form-label">Booster
                                #{{ $i }}</label>
                            <div class="input-group">
                                <span class="input-group-text @error(" booster.amp.$pre.$i") border border-danger
                                    @enderror" id="basic-addon-search1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" booster.amp.$pre.$i") border
                                    border-danger @enderror" wire:model="booster.amp.{{ $pre }}.{{ $i }}"
                                    placeholder="0.0 A">
                            </div>
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        <label class="form-label">H.P.</label>
                        <div class="input-group">
                            <span class="input-group-text @error(" hp.fre.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" hp.fre.$pre") border border-danger
                                @enderror" wire:model="hp.fre.{{ $pre }}" placeholder="0.0 Hz">
                        </div>
                        @error("hp.fre.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    @for ($i = 1; $i <= $plant->trains->first()->boosters_quantity; $i++)
                        <div class="col-6 mb-2">
                            <label class="form-label">Booster #
                                {{ $i }}</label>
                            <div class="input-group">
                                <span class="input-group-text @error(" booster.fre.$pre.$i") border border-danger
                                    @enderror" id="basic-addon-search1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" booster.fre.$pre.$i") border
                                    border-danger @enderror" wire:model="booster.fre.{{ $pre }}.{{ $i }}"
                                    placeholder="0.0 Hz">
                            </div>
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" ph.ope.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" ph.ope.$pre") border border-danger
                                @enderror" wire:model="ph.ope.{{ $pre }}" placeholder="0.0 u. pH">
                        </div>
                        @error("ph.ope.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" temperature.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" temperature.$pre") border border-danger
                                @enderror" wire:model="temperature.{{ $pre }}" placeholder="0.0 ºC">
                        </div>
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" feed.ope.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" feed.ope.$pre") border border-danger
                                @enderror" wire:model="feed.ope.{{ $pre }}" placeholder="0.0 ppm TDS">
                        </div>
                        @error("feed.ope.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" permeate.ope.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" permeate.ope.$pre") border border-danger
                                @enderror" wire:model="permeate.ope.{{ $pre }}" placeholder="0.0 ppm TDS">
                        </div>
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" reject.ope.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" reject.ope.$pre") border border-danger
                                @enderror" wire:model="reject.ope.{{ $pre }}" placeholder="0.0 ppm TDS">
                        </div>
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        ...
                        <label class="form-label">Feed</label>
                        <div class="input-group">
                            <span class="input-group-text @error(" feed.flo.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" feed.flo.$pre") border border-danger
                                @enderror" wire:model="feed.flo.{{ $pre }}" placeholder="0.0 gpm">
                        </div>
                        @error("feed.flo.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <label class="form-label">Permeate</label>
                        <div class="input-group">
                            <span class="input-group-text @error(" permeate.flo.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" permeate.flo.$pre") border border-danger
                                @enderror" wire:model="permeate.flo.{{ $pre }}" placeholder="0.0 gpm">
                        </div>
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <label class="form-label">Reject</label>
                        <div class="input-group">
                            <span class="input-group-text @error(" reject.flo.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" reject.flo.$pre") border border-danger
                                @enderror" wire:model="reject.flo.{{ $pre }}" placeholder="0.0 gpm">
                        </div>
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" booster.co.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" booster.co.$pre") border border-danger
                                @enderror" wire:model="booster.co.{{ $pre }}" placeholder="0.0 gpm">
                        </div>
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" hp.in.$pre") border border-danger
                                @enderror" wire:model="hp.in.{{ $pre }}" placeholder="0.0 psi">
                        </div>
                        @error("hp.in.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" hp.out.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" hp.out.$pre") border border-danger
                                @enderror" wire:model="hp.out.{{ $pre }}" placeholder="0.0 psi">
                        </div>
                        @error("hp.out.$pre")
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-4 mb-2">
                        <label class="form-label">Reject</label>
                        <div class="input-group">
                            <span class="input-group-text @error(" reject.pre.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" reject.pre.$pre") border border-danger
                                @enderror" wire:model="reject.pre.{{ $pre }}" placeholder="0.0 psi">
                        </div>
                    ...
                    <div class="col mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error(" booster.cp.$pre") border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" booster.cp.$pre") border border-danger
                                @enderror" wire:model="booster.cp.{{ $pre }}" placeholder="0.0 psi">
                        </div>
                        ...
                        @for ($i = 1; $i <= $plant->trains->first()->boosters_quantity; $i++)
                            <div class="col-md mb-2">
                                <label class="form-label">Booster #
                                    {{ $i }}</label>
                                <div class="input-group">
                                    <span class="input-group-text @error(" booster.pre.$pre.$i") border border-danger
                                        @enderror" id="basic-addon-search1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-asterisk @error(" booster.pre.$pre.$i")
                                            text-danger @enderror" viewBox="0 0 16 16">
                                            <path
                                                d="M8 0a1 1 0 0 1 1 1v5.268l4.562-2.634a1 1 0 1 1 1 1.732L10 8l4.562 2.634a1 1 0 1 1-1 1.732L9 9.732V15a1 1 0 1 1-2 0V9.732l-4.562 2.634a1 1 0 1 1-1-1.732L6 8 1.438 5.366a1 1 0 0 1 1-1.732L7 6.268V1a1 1 0 0 1 1-1z" />
                                        </svg>
                                    </span>
                                    <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" booster.pre.$pre.$i") border
                                        border-danger @enderror" wire:model="booster.pre.{{ $pre }}.{{ $i }}"
                                        placeholder="0.0 psi">
                                </div>
                ...
                <div class="mt-2">
                    <div class="form-floating mb-0">
                        <textarea data-length="350" class="form-control char-textarea"
                            wire:model="observations.ope.{{ $pre }}" rows="5" placeholder="Observations"
                            style="height: 100px"></textarea>
                        <label for="observations">Observations</label>
                    </div>
                    <small class="textarea-counter-value float-end"><span class="char-count">0</span> /
            ...
            <div class="card-body" x-show.transition.in="step === totalStep">
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error('ph.pro') border border-danger @enderror"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error('hardness') border border-danger @enderror"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error('tds') border border-danger @enderror"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" h2s.$pre") border border-danger @enderror"
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" @if ($plant->personalitation_plant->chloride == 'no') disabled @endif
                    ...
                    @for ($i = 1; $i <= $plant->trains->where('type', 'Train')->count(); $i++)
                        <div class="col mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" x-mask:dynamic="$money($input)" class="form-control @error(" reading.$i") border border-danger
                                    @enderror" wire:model="reading.{{ $i }}" placeholder="0.0 m3">
                            </div>
                            @error("reading.$i")
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            <span class="input-group-text @error('irrigation') border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-water @error('irrigation') text-danger @enderror" viewBox="0 0 16 16">
                                    <path
                                        d="M.036 3.314a.5.5 0 0 1 .65-.278l1.757.703a1.5 1.5 0 0 0 1.114 0l1.014-.406a2.5 2.5 0 0 1 1.857 0l1.015.406a1.5 1.5 0 0 0 1.114 0l1.014-.406a2.5 2.5 0 0 1 1.857 0l1.015.406a1.5 1.5 0 0 0 1.114 0l1.757-.703a.5.5 0 1 1 .372.928l-1.758.703a2.5 2.5 0 0 1-1.857 0l-1.014-.406a1.5 1.5 0 0 0-1.114 0l-1.015.406a2.5 2.5 0 0 1-1.857 0l-1.014-.406a1.5 1.5 0 0 0-1.114 0l-1.015.406a2.5 2.5 0 0 1-1.857 0L.314 3.964a.5.5 0 0 1-.278-.65zm0 3a.5.5 0 0 1 .65-.278l1.757.703a1.5 1.5 0 0 0 1.114 0l1.014-.406a2.5 2.5 0 0 1 1.857 0l1.015.406a1.5 1.5 0 0 0 1.114 0l1.014-.406a2.5 2.5 0 0 1 1.857 0l1.015.406a1.5 1.5 0 0 0 1.114 0l1.757-.703a.5.5 0 1 1 .372.928l-1.758.703a2.5 2.5 0 0 1-1.857 0l-1.014-.406a1.5 1.5 0 0 0-1.114 0l-1.015.406a2.5 2.5 0 0 1-1.857 0l-1.014-.406a1.5 1.5 0 0 0-1.114 0l-1.015.406a2.5 2.5 0 0 1-1.857 0L.314 6.964a.5.5 0 0 1-.278-.65zm0 3a.5.5 0 0 1 .65-.278l1.757.703a1.5 1.5 0 0 0 1.114 0l1.014-.406a2.5 2.5 0 0 1 1.857 0l1.015.406a1.5 1.5 0 0 0 1.114 0l1.014-.406a2.5 2.5 0 0 1 1.857 0l1.015.406a1.5 1.5 0 0 0 1.114 0l1.757-.703a.5.5 0 1 1 .372.928l-1.758.703a2.5 2.5 0 0 1-1.857 0l-1.014-.406a1.5 1.5 0 0 0-1.114 0l-1.015.406a2.5 2.5 0 0 1-1.857 0l-1.014-.406a1.5 1.5 0 0 0-1.114 0l-1.015.406a2.5 2.5 0 0 1-1.857 0L.314 9.964a.5.5 0 0 1-.278-.65zm0 3a.5.5 0 0 1 .65-.278l1.757.703a1.5 1.5 0 0 0 1.114 0l1.014-.406a2.5 2.5 0 0 1 1.857 0l1.015.406a1.5 1.5 0 0 0 1.114 0l1.014-.406a2.5 2.5 0 0 1 1.857 0l1.015.406a1.5 1.5 0 0 0 1.114 0l1.757-.703a.5.5 0 1 1 .372.928l-1.758.703a2.5 2.5 0 0 1-1.857 0l-1.014-.406a1.5 1.5 0 0 0-1.114 0l-1.015.406a2.5 2.5 0 0 1-1.857 0l-1.014-.406a1.5 1.5 0 0 0-1.114 0l-1.015.406a2.5 2.5 0 0 1-1.857 0l-1.757-.703a.5.5 0 0 1-.278-.65z" />
                                </svg>
                            </span>
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error('municipal') border border-danger @enderror"
                    ...
                    @for ($i = 1; $i <= $plant->cisterns_quantity; $i++)
                        <div class="col mb-2">
                            <label class="form-label">Tank
                                #{{ $i }}</label>
                            <div class="input-group">
                                <span class="input-group-text @error(" tanks.$i") border border-danger @enderror"
                                    id="basic-addon-search1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-moisture @error(" tanks.$i") text-danger @enderror"
                                        viewBox="0 0 16 16">
                                        <path
                                ...
                                <select class="form-select @error(" tanks.$i") border border-danger @enderror"
                                    wire:model="tanks.{{ $i }}">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        <label class="form-label">Sodium
                            Hypochloride</label>
                        <div class="input-group">
                            <span class="input-group-text @error('sodium_hypochloride') border border-danger @enderror"
                                id="basic-addon-search1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error('kl1') border border-danger @enderror"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" x-mask:dynamic="$money($input)" class="form-control @error('kl2') border border-danger @enderror"
                ...
                <div class="mt-2">
                    <div class="form-floating mb-0">
                        <textarea data-length="350" class="form-control char-textarea" wire:model="observations.prw"
    ...
    <script>
        ...
        window.addEventListener('successAlert', event => {
            Swal.fire({
                icon: 'success',
                title: 'Your Paramters has been Saved!',
                confirmButtonText: 'OK',
            }).then((result) => {
                /* Read more about isConfirmed, isDenied below */
                if (result.isConfirmed) {
                    Livewire.emit('redirec');
                }
            })
        });
