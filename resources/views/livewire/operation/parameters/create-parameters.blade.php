                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" pump.well.$pre") border border-danger
                    ...
                    <div class="col-sm-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" pump.feed.$pre") border border-danger
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" pump.wellf.$pre") border border-danger
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" pump.feedf.$pre") border border-danger
                    ...
                    <div class="row">
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error(" mm.in.$pre.$i") border border-danger
                        ...
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error(" mm.out.$pre.$i") border border-danger
                    ...
                    <div class="row">
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error(" pf.in.$pre") border border-danger
                        ...
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error(" pf.out.$pre") border border-danger
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" hp.amp.$pre") border border-danger
                    ...
                    @for ($i = 1; $i <= $plant->trains->first()->boosters_quantity; $i++)
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error(" booster.amp.$pre.$i") border
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" hp.fre.$pre") border border-danger
                    ...
                    @for ($i = 1; $i <= $plant->trains->first()->boosters_quantity; $i++)
                        <div class="col-6 mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error(" booster.fre.$pre.$i") border
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" ph.ope.$pre") border border-danger
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" temperature.$pre") border border-danger
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" feed.ope.$pre") border border-danger
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" permeate.ope.$pre") border border-danger
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" reject.ope.$pre") border border-danger
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" feed.flo.$pre") border border-danger
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" permeate.flo.$pre") border border-danger
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" reject.flo.$pre") border border-danger
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" booster.co.$pre") border border-danger
                ...
                <div class="row">
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" hp.in.$pre") border border-danger
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" hp.out.$pre") border border-danger
                    ...
                    <div class="col-4 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" reject.pre.$pre") border border-danger
                    ...
                    <div class="col mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" booster.cp.$pre") border border-danger
                        ...
                        @for ($i = 1; $i <= $plant->trains->first()->boosters_quantity; $i++)
                            <div class="col-md mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error(" booster.pre.$pre.$i") border
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('hardness') border border-danger @enderror"
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error(" h2s.$pre") border border-danger @enderror"
                    ...
                    @for ($i = 1; $i <= $plant->trains->where('type', 'Train')->count(); $i++)
                        <div class="col mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error(" reading.$i") border border-danger
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('municipal') border border-danger @enderror"
                        ...
                        <div class="col mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select @error(" tank.$i") border border-danger @enderror"
                                    ...
                                    @for ($j = 0; $j <= 100; $j++) <option value="{{ $j }}">{{ $j }}%</option>
                                        @endfor
                                </select>
                            </div>
                            @error("tank.$i")
