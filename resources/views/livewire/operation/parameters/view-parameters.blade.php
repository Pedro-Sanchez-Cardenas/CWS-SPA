<div wire:poll.60000ms>
            ...
            <div class="card-footer pb-0">
                <p class="card-subtitle mb-2 text-muted text-capitalize">Last Parameters:
                    ...
                    <span class="text-danger">{{
                        \Carbon\Carbon::create($plant->product_waters->first()->created_at)->diffForHumans()
                        }}</span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row gap-1">
                            ...
                            <div class="col-md-3 col-lg-4 border rounded py-1">
                                <h6>CISTERNS</h6>

                                <hr>

                                <div class="row gap-1 px-1">
                                    @for ($cistern = 0; $cistern < $parameters->first()->cisterns_quantity ; $cistern++)
                                        <div class="border rounded px-1">
                                                {{ $cistern + 1 }} - <small class="text-success">ENABLED</small>
                                        </div>
                                    @endfor
                                </div>
                            </div>
        ...
        <div class="col-sm-12 col-lg-4 p-0 m-0">
            ...
            <div wire:loading.remove wire:target='date_range' class="card">
                <div class="card-body m-0 p-0">
                    <div class="border rounded-top overflow-auto" style="height: 350pt;">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody class="m-0 p-0">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="m-0 py-0.5 px-0">
                                        @if (!$loop->parent->last)
                                        {{ $reading->reading - $parameters->first()->product_waters[$loop->parent->index
                                        + 1]->production_readings[$loop->index]->reading }}
                                        @else
                                        {{ $reading->reading }}
                                        @endif
                                    </td>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="badge bg-success py-1 px-2">TOTAL:
                            {{ $parameters->first()->product_waters->count() }}</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="border rounded-top overflow-auto" style="height: 350pt;">
                        ...
                        <table class="table table-sm table-bordered table-hover">
                            <thead class="sticky-top">
                                <tr class="text-center text-nowrap" role="row">
                                    <th
                                        colspan="@if ($plant->personalitation_plant->chloride == 'yes') 6 @else 5 @endif">
                                        FEED LINE TO
                                        HOTEL
                                        SUPPLY</th>
                    ...
                    <table class="table table-sm table-bordered table-hover">
                        <thead class="sticky-top">
                            <tr class="text-center text-nowrap" role="row">
                                ...
                                $plant->personalitation_plant->feed_pump != 'no')
                    ...
                    <table class="table table-sm table-bordered table-hover">
                        ...
                        <tbody class="m-0 p-0">
                            ...
                            <tr class="border-primary">
                                ...
                                $train >= 0;
                                $train--)
                                <td class="m-0 px-0 text-center" colspan="{{ $plant->trains->first()->boosters_quantity }}">
                                    <table class="w-100">
                                        <tbody>
                                            <tr class="@if ($train > 0) border-bottom @endif">
    ...
    @include('livewire.operation.parameters.addOperationManagerobservation')
    {{-- Modal Add Operation Manager Observation End --}}

    {{-- Modal Edit Parameters --}}
    @include('livewire.operation.parameters.editProductWater')
    {{-- Modal Edit parameters --}}
</div>
