                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-md">
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <input type="number" @keyup="sumarM3()" disabled wire:model.lazy="oymM3" id="o&mM3"
                                        class="form-control ps-1" placeholder="0.00"
                                        aria-label="Amount (to the nearest dollar)">
                                    <span class="input-group-text">USD/M3</span>
                                </div>
                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-md">
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    ...
                                    <input type="number" @keyup="sumarMonth()" disabled wire:model.lazy="oymFixed"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text @error("billingDay") border border-danger @enderror" id="basic-addon-search1"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="@error("billingDay") text-danger @enderror"
