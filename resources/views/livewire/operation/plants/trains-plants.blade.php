                            ...
                            <div class="row">
                                ...
                                <div class="col-md mb-2">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text @error('capacity') border border-danger @enderror">
                                ...
                                <div class="col-md mb-2">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" wire:model="trains.tds"
                                ...
                                <div class="col-md mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select
                                            ...
                                            id="trainBooster" wire:model="trains.booster">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        ...
                                        <input type="number"
                                            ...
                                            wire:model="trains.mElements" placeholder="0.00"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <select
                                            ...
                                            id="trains.mArea" wire:model="trains.mArea">
                                ...
                                <div class="col-md mb-2">
                                    ...
                                    <div class="input-group ">
                                        ...
                                        <select
                                            ...
                                            id="multimediaFilsters" wire:model="trains.multimediaFilsters">
                                ...
                                <div class="col-md mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select
                                            ...
                                            id="polishFilters" wire:model="trains.polishFilters">
                                            <option value="">SELECT TYPE</option>
                                ...
                                <div class="col-md mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select
                                            ...
                                            id="polishQuantity" wire:model="trains.polishQuantity">
