                        ...
                        <div class="col-md-6">
                            <div class="card" x-data="dropdown()" x-cloak>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="me-1">
                                        Total extra: <span class="text-danger font-bold" x-text="cisterns.length"></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card" x-data="dropdown()" x-cloak>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="me-1">
                                        Total discount: <span class="text-danger font-bold" x-text="cisterns.length"></span>
                                    </div>
                                </div>
                                <div class="ms-2">
                                    <button type="button" @click="toggle()"
                                ...
                                <div class="card-footer">
                                    <p>If you have any discount, use the button.</p>
                                </div>
                            </div>
                            </div>
                            <script>
