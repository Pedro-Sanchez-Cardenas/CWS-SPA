                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        <span class="input-group-text">
                                            <div class="form-check">
                                                <input type="radio" name="bot" class="form-check-input"
                                                    id="botM3">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        <span class="input-group-text">
                                            <div class="form-check">
                                                <input type="radio" name="o&m" class="form-check-input"
                                                    id="o&mFixed">
                                                <label class="form-check-label" for="colorRadio1"></label>
                                            </div>
                                        </span>
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="input-group input-group-merge mb-2">
                                        <span class="input-group-text">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" name="remineralisationM3"
                                                    id="colorRadio1">
                                                <label class="form-check-label" for="colorRadio1"></label>
                                            </div>
                                        </span>
