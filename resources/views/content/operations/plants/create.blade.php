        ...
        <section class="row">
            <div class="col-md-6">
                <div class="card" x-data="cisterns()" x-cloak>
                    ...
                    <div class="ms-2">
                        <button type="button" @click="add()" class="btn btn-success waves-effect waves-float waves-light">
                                ...
                                <div class="col-md-11">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input :id="'cisterns[capacity][' + index + ']'" name="cisterns[capacity][]"
                                            ...
                                            placeholder="0.0 lt" aria-label="0.0 lt..." aria-describedby="plantNameicon">
                                    </div>
                                </div>
                                <div class="col ms-1">
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    <span class="input-group-text">
                                        <div class="form-check">
                                            <input type="radio" @click="action('bot1'), sumarM3(), sumarMonth()" name="bot"
                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-md">
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    <span class="input-group-text">
                                        <div class="form-check">
                                            <input type="radio" @click="action('bot2'), sumarM3(), sumarMonth()" name="bot"
                                                class="form-check-input">
                                            <label class="form-check-label" for="colorRadio1"></label>
                                        </div>
                                    </span>
                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-md">
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    <span class="input-group-text">
                                        <div class="form-check">
                                            <input type="radio" @click="action('o&m1'), sumarM3(), sumarMonth()" name="o&m"
                                                class="form-check-input">
                                            <label class="form-check-label" for="colorRadio1"></label>
                                        </div>
                                    </span>
                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-md">
                                ...
                                <div class="input-group input-group-merge mb-2">
                                    <span class="input-group-text">
                                        <div class="form-check">
                                            <input type="radio" @click="action('o&m2'), sumarM3(), sumarMonth()" name="o&m"
                                                class="form-check-input">
                                            <label class="form-check-label" for="colorRadio1"></label>
                                        </div>
                                    </span>
                                ...
                                <div data-repeater-list="invoice">
                                    <div data-repeater-item>
                                        <div class="row d-flex align-items-end">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="validationDefault04" class="form-label">#Menbrane
                                                        elements</label>
                                                    <div class="input-group input-group-merge mb-2">
                                                        <span class="input-group-text"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <div class="col-md">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <select class="form-select" id="basicSelect" name="polishFilters">
                                                        <option value="">SELECT TYPE</option>
                                            ...
                                            <div class="col-md">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <select class="form-select" id="basicSelect" name="polishQuantity">
