                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <h2>{{ $plant->cisterns_quantity }} Cisterns <i class="fas fa-prescription-bottle"></i></h2>
                                </div>
                            </div>
                            ...
                            <div class="btn-group col-12" role="group">
                                <a href="{{ route('parameters.create', $plant->id) }}" class="btn btn-success"><i class="fas fa-plus"></i> Parameters</a>
