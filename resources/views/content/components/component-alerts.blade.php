                    ...
                    <div class="card-body">
                        ...
                        <div class="demo-spacing-0">
                            <div class="alert alert-primary" role="alert">
                                <div class="alert-body"><strong>Good Morning!</strong> Start your day with some alerts.
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="demo-spacing-0">
                            <div class="alert alert-warning" role="alert">
                                ...
                                <div class="alert-body">
                                    Lorem ipsum dolor sit amet <a href="#" class="alert-link">consectetur</a>
                        ...
                        <div class="demo-spacing-0">
                            <div class="alert alert-primary" role="alert">
                                <div class="alert-body d-flex align-items-center">
                                    ...
                                    <span> Chupa chups topping bonbon. Jelly-o toffee I love. Sweet I love wafer I love
                                        wafer.</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            ...
                            <code>.alert-validation</code> for your input and class <code>.alert-validation-msg</code> with
                            your alert.
                        </p>
                        <form>
                            <label for="numbers" class="form-label">Enter Only Numbers</label>
                            <input id="numbers" class="form-control w-25 h-25 alert-validation" type="text"
