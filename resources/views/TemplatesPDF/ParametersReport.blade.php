...
<body>
        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <td class="td-img text-center">
                    <img class="mt-3" src="{{ asset('storage/logo_v1.png') }}" alt="">
                </td>
            </tbody>
        </table>
    </header>
    ...
    @foreach ($parameters->first()->product_waters as $product_water)
        <main>
            <strong class="text-primary">{{ $loop->iteration }})
                {{ $product_water->created_at->toDatestring() }}</strong>
            ...
            <h6 style="font-size: 11px" class="{{ $parameters->first()->trains->where('type', 'Train')->count() == 2 ? 'mt-2' : 'mt-4' }}">PRODUCT WATER</h6>
            ...
            <h6 style="font-size: 11px" class="{{ $parameters->first()->trains->where('type', 'Train')->count() == 2 ? 'mt-2' : 'mt-4' }}">PRETREATMENT</h6>
            ...
            <h6 style="font-size: 11px" class="{{ $parameters->first()->trains->where('type', 'Train')->count() == 2 ? 'mt-3' : 'mt-4' }}">OPERATION</h6>
            <table style="width: 100%;" border="1">
                <thead style="font-size: 10px">
                    <tr class="text-center" role="row">
                        <th>TRAIN</th>
